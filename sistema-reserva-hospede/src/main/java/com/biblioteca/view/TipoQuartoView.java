...
public class TipoQuartoView {
    ...
    // Inicialização do controlador de tipos de quarto e scanner
    public TipoQuartoView() {
        tipoQuartoController = new TipoQuartoController();
        scanner = new Scanner(System.in);
    }

    // Exibe todos os tipos de quarto
    ...
    public void addTipoQuarto() {
        System.out.println("Digite o ID do tipo de quarto:");
    ...
    // Deleta um tipo de quarto existente
    ...
    // Função principal para executar o menu de interação
