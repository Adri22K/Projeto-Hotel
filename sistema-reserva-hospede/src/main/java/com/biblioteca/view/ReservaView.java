...
public class ReservaView {
    ...
    // Inicialização do controlador de reservas, scanner e formatação de datas
    public ReservaView() {
    ...
    public void addReserva() {
        ...
        // Criação da reserva sem o idReservas
        Reserva reserva = new Reserva(java.sql.Date.valueOf(dataInicio), java.sql.Date.valueOf(dataFim), dataFimStr, idHospede, idFuncionario, idQuarto);
    ...
    public void updateReserva() {
        ...
        Reserva reserva = new Reserva(id, java.sql.Date.valueOf(dataInicio), java.sql.Date.valueOf(dataFim), dataFimStr, idHospede, idFuncionario, idQuarto);
