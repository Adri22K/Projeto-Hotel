...
public class Reserva {
    ...
    // Construtor para criar uma nova reserva sem idReservas
    public Reserva(Date dataCheckin, Date dataCheckout, String status, int idHospedes, int idFuncionario, int idQuarto) {
    ...
    // Construtor completo para uso quando todos os atributos são conhecidos
